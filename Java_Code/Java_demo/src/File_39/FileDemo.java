...
/*
    File：文件和目录路径名的抽象表示
          ...
          2.对于File而言，其封装的并不是一个真正存在的文件，仅仅是一个路径名而已。它是可以存在的，也可以是不存在的。
...
public class FileDemo {
    public static void main(String[] args) {
        ...
        File f2 = new File("E:\\IntelliJ_IDEA\\Java_Study\\Java_Code\\Java_demo\\File","java.txt");
        System.out.println(f2);

        //3.File(File parent,String child)：从父抽象路径名和子路径名字符串创建新的File实例
        File f3 = new File("E:\\IntelliJ_IDEA\\Java_Study\\Java_Code\\Java_demo\\File");
