...
/*
    InputStreamReader:是从字节流到字符流的桥梁
        ...
        它使用的字符集可以有名称指定，也可以被明确指定，或者可以接受平台的默认字符集
...
//        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("Java_demo\\File\\osw.txt"),"UTF-8");
        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("Java_demo\\File\\osw.txt"),"GBK");
        osw.write("中国");
        osw.close();
        ...
        InputStreamReader isr = new InputStreamReader(new FileInputStream("Java_demo\\File\\osw.txt"),"GBK");
